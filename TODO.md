...
-the "Tee" data in the shotpattern export should only be the clubs 1W and 3W, not LW, SW, PW, or AW.
-The data in the shot pattern should be individual shots, not any summaries or aggregates.