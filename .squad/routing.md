...
|-----------|----------|----------|
| Architecture & decisions | Keaton | Data model design, project structure, tech choices |
| Backend / data processing | Fenster | Flask routes, SQLAlchemy models, CSV parsing, Pandas analytics, matrix generation |
| Frontend / UI | McManus | HTML templates, Bootstrap layout, Chart.js visualizations, print CSS, import UI |
| Code review | Keaton | Review PRs, check quality, suggest improvements |
| Testing | Hockney | Unit tests, edge cases, data validation, CSV parsing tests |
